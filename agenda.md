...
<table class="agenda">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Srikar Yadala (NTNU); Lara Ejtehadian (Aalto)<br>
...
<table class="agenda">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        I will share my experiences and opinions to solutions that we at BIRGHT trying to turn scattered research data into a coherent and well-governed asset. I will share our strategies for integrations of lab data, computational analyses, lab data and DMP. This presentation aims to stimuate discussions for architectural choices, lessons learned, and common pitfalls when building an end-to-end research data management infrastructure.
      </td>
      <td>
        Ding He<br>
